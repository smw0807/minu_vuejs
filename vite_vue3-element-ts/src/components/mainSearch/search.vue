...
const gameTypes: Ref<gameType[]> = ref([ //셀렉트박스 options 데이터
...
onMounted(() => {
  if (!_lsGameType) { //로컬스토리지 아이템이 없으면 셋팅
      ...
      <el-col align="middle">
        <el-input
          ...
          <template #prepend>
            ...
            <el-select v-model="selGameType" @change="changeGameType" style="width: 115px" size="large">
              <el-option 
