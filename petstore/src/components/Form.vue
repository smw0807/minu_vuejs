<template>
    <div>
      <my-header :cartItemCount="cartItemCount"></my-header> <!-- Header.vue 컴포넌트가 전달받은 cartItermCount 값을 보여준다. -->
      <div class="row">
...
<script>
import MyHeader from './Header.vue'; //Header.vue 컴포넌트를 불러온다.
export default {
  name: 'Form',
  props: ['cartItemCount'], // cartItemCount 속성을 전달한다.
  data() {
    return {
      states: {
        AL: '알라바마',
